...
def parse_hh_vacancies(page):
    ...
    params = {
        "text": "Python OR Java OR C++ OR JavaScript OR PHP OR Ruby OR JavaScript OR C# OR Swift OR Go OR Rust OR "
                "TypeScript OR Kotlin OR Perl OR R OR Objective-C OR MATLAB OR Scala OR HTML OR CSS OR SQL OR GIT OR "
                "Bash OR React OR Vue.js OR Aurora OS OR Аврора ОС",
        "per_page": 100,
        "area": 1,
        "page": page,
        'premium': 'true'
...
if __name__ == "__main__":
    ...
    df.to_excel("vacancies1212.xlsx", index=False)
